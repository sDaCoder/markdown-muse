...
import SignedInJWT from './components/SignedInJWT/SignedInJWT'
import SignedOutJWT from './components/SignedOutJWT/SignedOutJWT'
          ...
          <main className='min-w-0 flex-1'>
            ...
            <Routes>
              ...
              <Route path='/editor/:textId' element={
                <SignedInJWT fallback={<Navigate to='/' replace />}>
                  <EditPage/>
                </SignedInJWT>
              } />
